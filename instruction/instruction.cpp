...
Instruction* getInstrucion(uint8_t opCode){
	...
	// case 0x15: return NewLoad(false);
	// case 0x16: return NewLoad(true);
	// case 0x17: return NewLoad(false);
	// case 0x18: return NewLoad(true);
	// case 0x19: return NewLoad(false);
	...
	// case 0x36: return NewStore(false);
	// case 0x37: return NewStore(true);
	// case 0x38: return NewStore(false);
	// case 0x39: return NewStore(true);
	// case 0x3a: return NewStore(false);
	...
	// case 0x99: return NewIfEQ();
	// case 0x9a: return NewIfNE();
	// case 0x9b: return NewIfLT();
	// case 0x9c: return NewIfGE();
	// case 0x9d: return NewIfGT();
	// case 0x9e: return NewIfLE();
